...
const GaussJordan =()=>{
    ...
    const calculateLinear = () =>{
        ...
        const Acheck = [];
        if(Sizematrix == 2){
            a1.push(parseFloat(A11),parseFloat(A12),parseFloat(B11));
            a2.push(parseFloat(A21),parseFloat(A22),parseFloat(B21));
            A.push(a1,a2);
